...
Namespace Finance_Payment
    <FormAttribute("FOUTPAY", "Business Objects/FrmOutPayments.b1f")>
    Friend Class FrmOutPayments
        ...
        Public Overrides Sub OnInitializeComponent()
            ...
            Me.StaticText6 = CType(Me.GetItem("lcigl").Specific, SAPbouiCOM.StaticText)
            Me.EditText5 = CType(Me.GetItem("tbitot").Specific, SAPbouiCOM.EditText)
            Me.StaticText7 = CType(Me.GetItem("lbtot").Specific, SAPbouiCOM.StaticText)
            Me.StaticText8 = CType(Me.GetItem("lbigl").Specific, SAPbouiCOM.StaticText)
            ...
            Me.StaticText9 = CType(Me.GetItem("lcitot").Specific, SAPbouiCOM.StaticText)
            Me.StaticText10 = CType(Me.GetItem("ltran").Specific, SAPbouiCOM.StaticText)
            Me.StaticText11 = CType(Me.GetItem("lcash").Specific, SAPbouiCOM.StaticText)
            Me.StaticText12 = CType(Me.GetItem("lchigl").Specific, SAPbouiCOM.StaticText)
            ...
            Me.StaticText17 = CType(Me.GetItem("ljeno").Specific, SAPbouiCOM.StaticText)
            ...
            Me.StaticText18 = CType(Me.GetItem("lrecno").Specific, SAPbouiCOM.StaticText)
            Me.EditText14 = CType(Me.GetItem("tjeno").Specific, SAPbouiCOM.EditText)
            Me.LinkedButton1 = CType(Me.GetItem("lnkre").Specific, SAPbouiCOM.LinkedButton)
            Me.StaticText19 = CType(Me.GetItem("ltranno").Specific, SAPbouiCOM.StaticText)
            Me.EditText15 = CType(Me.GetItem("trecno").Specific, SAPbouiCOM.EditText)
            Me.LinkedButton2 = CType(Me.GetItem("lktra").Specific, SAPbouiCOM.LinkedButton)
            Me.Button2 = CType(Me.GetItem("paymeans").Specific, SAPbouiCOM.Button)
            ...
            Me.StaticText24 = CType(Me.GetItem("lforex").Specific, SAPbouiCOM.StaticText)
            ...
            Me.StaticText28 = CType(Me.GetItem("lcfxje").Specific, SAPbouiCOM.StaticText)
            Me.EditText23 = CType(Me.GetItem("tacttot").Specific, SAPbouiCOM.EditText)
            Me.LinkedButton4 = CType(Me.GetItem("lkcfxje").Specific, SAPbouiCOM.LinkedButton)
            ...
            Me.StaticText31 = CType(Me.GetItem("lacttot").Specific, SAPbouiCOM.StaticText)
            ...
            Me.StaticText34 = CType(Me.GetItem("loutseries").Specific, SAPbouiCOM.StaticText)
            Me.EditText29 = CType(Me.GetItem("toutseries").Specific, SAPbouiCOM.EditText)
        ...
        Private Sub OnCustomInitialize()
            Try
                objform = objaddon.objapplication.Forms.GetForm("FOUTPAY", Me.FormCount)
                ...
                objaddon.objglobalmethods.LoadSeries(objform, odbdsHeader, "MIOVPM")
                oSelectedDT.Clear()
                ...
                If objaddon.objglobalmethods.Get_Branch_Assigned_Series("46", PayInitDate.ToString("yyyyMMdd")) Then
                ...
                'Matrix0.Layout = SAPbouiCOM.BoMatrixLayoutType.mlt_Vertical
...
#Region "Form Events"
        ...
        Private Sub Button0_ClickBefore(sboObject As Object, pVal As SAPbouiCOM.SBOItemEventArg, ByRef BubbleEvent As Boolean) Handles Button0.ClickBefore
            Try
                ...
                'objFinalDT.Clear()
                'objFinalDT = build_Matrix_DataTable("paytot")
                ...
                Try
                    Dim GetPayDT = From dr In objFinalDT.AsEnumerable()
                                   Where dr.Field(Of String)("object") = "18" And dr.Field(Of Double)("paytot") > 0
                ...
                If EditText18.Value = MainCurr Then
                    GetTot = CDbl(EditText5.Value) + CDbl(EditText9.Value) + CDbl(EditText11.Value) + CDbl(EditText12.Value)
                ...
                If objaddon.objglobalmethods.Get_Branch_Assigned_Series("24", PayInitDate.ToString("yyyyMMdd")) = False Then
                    If EditText29.Value = "" Then objaddon.objapplication.StatusBar.SetText("Please Select the Series for posting the Outgoing Payment...", SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error) : BubbleEvent = False : Exit Sub
                ...
                If OutgoingPayment(objFinalDT, Line, CurBranch, CurBPCode) = False Then
                    ErrorFlag = True
                ...
                Try
                    ...
                    'If EditText18.Value <> MainCurr Then
                    '    objRs.DoQuery("select T1.""DebCred"",T1.""Line_ID"",CASE WHEN T1.""BalDueCred""<>0  THEN  T1.""BalDueCred"" ELSE T1.""BalDueDeb"" END AS ""Balance"" from JDT1 T1 where T1.""ShortName"" in (Select ""CardCode"" from OCRD) and T1.""TransId""=(Select ""TransId"" from OVPM where ""DocEntry""=" & EditText13.Value & ") ")
                    ...
                    '                    strSQL = "Select ""Rate"",""Currency"" from ORTT where ""RateDate""= '" & DocumentDate.ToString("yyyyMMdd") & "'"
                    '                    objRs = objaddon.objcompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                    '                    objRs.DoQuery(strSQL)
                    '                    If objRs.RecordCount = 0 Then
                    ...
                    '                                objExcRateDT.Rows.Add(1, MainCurr)
                    '                            End If
                    '                            objExcRateDT.Rows.Add(objRs.Fields.Item(0).Value, objRs.Fields.Item(1).Value)
                    '                            objRs.MoveNext()
                    '                        Next
                    '                    End If
                    '                    Dim ERate = From dr In objExcRateDT.AsEnumerable()
                    '                                Select New With {Key .Curr = dr.Field(Of String)("doccur"),
                    '                                       Key .Rate = CDbl(dr.Field(Of Double)("Rate"))}

                    '                    Dim DT = From dr In objFinalDT.AsEnumerable()
                    '                             Select New With {Key .Curr = dr.Field(Of String)("doccur"), Key .Branch = dr.Field(Of String)("branchc"), Key .BPCode = dr.Field(Of String)("cardc"), Key .Tot = dr.Field(Of Double)("paytot")
                    '                                       }
...
#Region "Functions"
            ...
            Try
                ...
                If objRs.RecordCount > 0 Then
                    ...
                    While Not objRs.EoF
                        ...
                        'objform.DataSources.UserDataSources.Item("UD_1").Value = objRs.Fields.Item("Balance").Value.ToString
        ...
        '                oRow.Item(Matrix0.Columns.Item("paytot").UniqueID) = Matrix0.Columns.Item("paytot").Cells.Item(iRow).Specific.Value
        '                oRow.Item(Matrix0.Columns.Item("doccur").UniqueID) = Matrix0.Columns.Item("doccur").Cells.Item(iRow).Specific.Value
        '                'oRow.Item(Matrix0.Columns.Item("cashdisc").UniqueID) = Matrix0.Columns.Item("cashdisc").Cells.Item(iRow).Specific.Value
        '                objDT.Rows.Add(oRow)
        '            End If
        '        Next
        '        DocumentDate = Date.ParseExact(EditText0.Value, "yyyyMMdd", System.Globalization.DateTimeFormatInfo.InvariantInfo)
        ...
        '            'objform.DataSources.UserDataSources.Item("UD_FC").ValueEx = "****"
        '            'odbdsHeader.SetValue("U_TotalFC", 0, "****")
        '        Else
        '            EditText20.Value = valueFC
        '            'odbdsHeader.SetValue("U_TotalFC", 0, valueFC) 'TotalFC
        '            'objform.DataSources.UserDataSources.Item("UD_FC").ValueEx = valueFC
        '        End If
...
ExCalc:         DocumentDate = Date.ParseExact(EditText0.Value, "yyyyMMdd", System.Globalization.DateTimeFormatInfo.InvariantInfo)
                For i As Integer = 0 To oSelectedDT.Rows.Count - 1
                    If Val(oSelectedDT.Rows(i)("paytot")) <> 0 Then
                        If oSelectedDT.Rows(i)("doccur").ToString = MainCurr Then
                            'Dim no As String = oSelectedDT.Rows(i)("#").ToString
                            ...
                            'objaddon.objglobalmethods.WriteErrorLog("Actual Value: " + CStr(Math.Round(oSelectedDT.Rows(i)("paytot"), 6)) + " ValueLC: " + CStr(valueLC) + " Row: " + CStr(no) + " DTRow: " + CStr(i))
                            LCFlag = True
                        Else
                ...
                odbdsHeader.SetValue("U_Total", 0, valueLC) 'Total
                odbdsHeader.SetValue("U_ActTotal", 0, valueLC) 'Actual Total
                odbdsHeader.SetValue("U_OutTotal", 0, valueLC) 'ActualValue
                If LCFlag And FCFlag Then
                    EditText20.Value = "****"
                    LCFlag = False : FCFlag = False
                Else
        ...
        Private Function OutgoingPayment(ByVal InDT As DataTable, ByVal LineNum As Integer, ByVal Branch As String, ByVal CardCode As String) As Boolean
            Try
                Dim objOutpay As SAPbobsCOM.Payments
                Dim DocEntry, Series As String
                If EditText13.Value = "" Then
                    objOutpay = objaddon.objcompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.oVendorPayments)
                    objOutpay.DocObjectCode = SAPbobsCOM.BoPaymentsObjectType.bopot_OutgoingPayments
                    objOutpay.DocType = SAPbobsCOM.BoRcptTypes.rSupplier
                    objOutpay.CardCode = CardCode ' Matrix0.Columns.Item("cardc").Cells.Item(LineNum).Specific.String
                    objOutpay.BPLID = Branch ' Matrix0.Columns.Item("branchc").Cells.Item(LineNum).Specific.String
                    objOutpay.Remarks = "Out Payment add-on"
                    objOutpay.UserFields.Fields.Item("U_PayOutNo").Value = EditText2.Value
                    Dim DocDate As Date = Date.ParseExact(EditText0.Value, "yyyyMMdd", System.Globalization.DateTimeFormatInfo.InvariantInfo)
                    objOutpay.DocDate = DocDate 'Matrix0.Columns.Item("date").Cells.Item(LineNum).Specific.String

                    objOutpay.DocCurrency = EditText18.Value 'Matrix0.Columns.Item("doccur").Cells.Item(LineNum).Specific.String
                    If Val(EditText21.Value) > 0 Then objOutpay.DocRate = CDbl(EditText21.Value)
                    'objIncom.LocalCurrency = BoYesNoEnum.tYES
                    If Localization = "IN" Then
                        If objaddon.HANA Then
                            Series = objaddon.objglobalmethods.getSingleValue("SELECT Top 1 ""Series"" FROM NNM1 WHERE ""ObjectCode""='46' and ""Indicator""=(Select ""Indicator"" from OFPR where '" & DocDate.ToString("yyyyMMdd") & "' Between ""F_RefDate"" and ""T_RefDate"") " &
                    ...
                    Else
                        ...
                        End If
                    End If
                    If Series <> "" Then objOutpay.Series = Series Else objOutpay.Series = EditText29.Value
                    ...
                    If Matrix1.VisualRowCount > 0 Then
                        If Val(Matrix1.Columns.Item("chamt").Cells.Item(1).Specific.String) > 0 Then 'Cheque
                            'objOutpay.CheckAccount = EditText10.Value
                            For Row As Integer = 1 To Matrix1.VisualRowCount
                                If Val(Matrix1.Columns.Item("chamt").Cells.Item(Row).Specific.String) > 0 Then
                                    If Matrix1.Columns.Item("chnum").Cells.Item(Row).Specific.String <> "" Then objOutpay.Checks.CheckNumber = Trim(Matrix1.Columns.Item("chnum").Cells.Item(Row).Specific.String)
                                    If Matrix1.Columns.Item("glacc").Cells.Item(Row).Specific.String <> "" Then objOutpay.Checks.CheckAccount = Matrix1.Columns.Item("glacc").Cells.Item(Row).Specific.String
                                    objOutpay.Checks.CheckSum = Math.Round(CDbl(Matrix1.Columns.Item("chamt").Cells.Item(Row).Specific.String), SumRound)
                                    ...
                                    objOutpay.Checks.DueDate = chDate ' Matrix1.Columns.Item("chdate").Cells.Item(Row).Specific.String
                                    If Matrix1.Columns.Item("chcty").Cells.Item(Row).Specific.String <> "" Then objOutpay.Checks.CountryCode = Matrix1.Columns.Item("chcty").Cells.Item(Row).Specific.String
                                    If Matrix1.Columns.Item("chbank").Cells.Item(Row).Specific.String <> "" Then objOutpay.Checks.BankCode = Matrix1.Columns.Item("chbank").Cells.Item(Row).Specific.String
                                    If Matrix1.Columns.Item("chbranch").Cells.Item(Row).Specific.String <> "" Then objOutpay.Checks.Branch = Matrix1.Columns.Item("chbranch").Cells.Item(Row).Specific.String
                                    If Matrix1.Columns.Item("chact").Cells.Item(Row).Specific.String <> "" Then objOutpay.Checks.AccounttNum = Matrix1.Columns.Item("chact").Cells.Item(Row).Specific.String
                                    If Matrix1.Columns.Item("chissue").Cells.Item(Row).Specific.String <> "" Then objOutpay.Checks.OriginallyIssuedBy = Trim(Matrix1.Columns.Item("chissue").Cells.Item(Row).Specific.String)
                                    If Matrix1.Columns.Item("chfiscal").Cells.Item(Row).Specific.String <> "" Then objOutpay.Checks.FiscalID = Trim(Matrix1.Columns.Item("chfiscal").Cells.Item(Row).Specific.String)
                                    If Matrix1.Columns.Item("chendor").Cells.Item(Row).Specific.String = "Y" Then
                                        objOutpay.Checks.Trnsfrable = BoYesNoEnum.tYES
                                    Else
                                        objOutpay.Checks.Trnsfrable = BoYesNoEnum.tNO
                                    End If
                                    objOutpay.Checks.Add()
                                End If
                            Next
                        End If
                    End If
                    If Val(EditText17.Value) > 0 Then 'BCG Amount
                        objOutpay.BankAccount = EditText16.Value
                        objOutpay.BankChargeAmount = Math.Round(CDbl(EditText17.Value), SumRound)
                    End If


                    If Val(EditText5.Value) > 0 Then 'Transfer
                        objOutpay.TransferAccount = EditText6.Value
                        objOutpay.TransferSum = Math.Round(CDbl(EditText5.Value), SumRound)
                        objOutpay.TransferDate = Date.ParseExact(EditText4.Value, "yyyyMMdd", System.Globalization.DateTimeFormatInfo.InvariantInfo)
                        objOutpay.TransferReference = EditText7.Value
                    End If
                    If Matrix2.VisualRowCount > 0 Then
                        ...
                        If Val(Matrix2.Columns.Item("amtdue").Cells.Item(1).Specific.String) > 0 Then  'Card
                            objOutpay.CreditCards.CreditCard = Matrix2.Columns.Item("cardname").Cells.Item(1).Specific.String
                            objOutpay.CreditCards.CreditCardNumber = Matrix2.Columns.Item("cardno").Cells.Item(1).Specific.String
                            objOutpay.CreditCards.CreditAcct = Matrix2.Columns.Item("cardgl").Cells.Item(1).Specific.String
                            ...
                            objOutpay.CreditCards.CardValidUntil = CDate(GetDate)
                            If Matrix2.Columns.Item("idno").Cells.Item(1).Specific.String <> "" Then objOutpay.CreditCards.OwnerIdNum = Matrix2.Columns.Item("idno").Cells.Item(1).Specific.String
                            If Matrix2.Columns.Item("telno").Cells.Item(1).Specific.String <> "" Then objOutpay.CreditCards.OwnerPhone = Matrix2.Columns.Item("telno").Cells.Item(1).Specific.String
                            objOutpay.CreditCards.CreditSum = Math.Round(CDbl(Matrix2.Columns.Item("amtdue").Cells.Item(1).Specific.String), SumRound)
                            If Matrix2.Columns.Item("appcode").Cells.Item(1).Specific.String <> "" Then objOutpay.CreditCards.VoucherNum = Matrix2.Columns.Item("appcode").Cells.Item(1).Specific.String
                            If Matrix2.Columns.Item("trantype").Cells.Item(1).Specific.String = "I" Then
                                objOutpay.CreditCards.CreditType = BoRcptCredTypes.cr_InternetTransaction
                            ElseIf Matrix2.Columns.Item("trantype").Cells.Item(1).Specific.String = "S" Then
                                objOutpay.CreditCards.CreditType = BoRcptCredTypes.cr_Regular
                            Else
                                objOutpay.CreditCards.CreditType = BoRcptCredTypes.cr_Telephone
                            End If
                            objOutpay.CreditCards.Add()
                        End If
                    End If
                    If Val(EditText9.Value) > 0 Then 'Cash
                        objOutpay.CashAccount = EditText8.Value
                        objOutpay.CashSum = Math.Round(CDbl(EditText9.Value), SumRound)
                    End If
                    For i As Integer = 0 To InDT.Rows.Count - 1
                        If CDbl(InDT.Rows(i)("paytot").ToString) <> 0 And InDT.Rows(i)("cardc").ToString = CurBPCode And InDT.Rows(i)("branchc").ToString = CurBranch Then
                            objOutpay.Invoices.TotalDiscount = CDbl(InDT.Rows(i)("cashdisc").ToString)
                            If InDT.Rows(i)("doccur").ToString = MainCurr Then
                                objOutpay.Invoices.SumApplied = Math.Round(CDbl(InDT.Rows(i)("paytot").ToString), SumRound) ' InvTotal
                            Else
                                'strSQL = "Select ""Rate"",""Currency"" from ORTT where ""RateDate""= '" & DocDate.ToString("yyyyMMdd") & "' and ""Currency""='" & EditText18.Value & "' "
                                'objRs = objaddon.objcompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
                                'objRs.DoQuery(strSQL)
                                objOutpay.Invoices.AppliedFC = Math.Round(CDbl(InDT.Rows(i)("paytot").ToString), SumRound) '/ CDbl(objRs.Fields.Item(0).Value.ToString)
                            End If
                            objOutpay.Invoices.DocEntry = CInt(InDT.Rows(i)("docentry").ToString)
                            If InDT.Rows(i)("objtype").ToString = "PU" Then
                                objOutpay.Invoices.InvoiceType = SAPbobsCOM.BoRcptInvTypes.it_PurchaseInvoice
                            ElseIf InDT.Rows(i)("objtype").ToString = "PC" Then
                                objOutpay.Invoices.InvoiceType = SAPbobsCOM.BoRcptInvTypes.it_PurchaseCreditNote
                            ElseIf InDT.Rows(i)("objtype").ToString = "JE" Then
                                objOutpay.Invoices.DocLine = CInt(InDT.Rows(i)("tranline").ToString)
                                objOutpay.Invoices.InvoiceType = SAPbobsCOM.BoRcptInvTypes.it_JournalEntry
                            End If
                            If InDT.Rows(i)("cc1").ToString <> "" Then objOutpay.Invoices.DistributionRule = InDT.Rows(i)("cc1").ToString
                            If InDT.Rows(i)("cc2").ToString <> "" Then objOutpay.Invoices.DistributionRule2 = InDT.Rows(i)("cc2").ToString
                            If InDT.Rows(i)("cc3").ToString <> "" Then objOutpay.Invoices.DistributionRule3 = InDT.Rows(i)("cc3").ToString
                            If InDT.Rows(i)("cc4").ToString <> "" Then objOutpay.Invoices.DistributionRule4 = InDT.Rows(i)("cc4").ToString
                            If InDT.Rows(i)("cc5").ToString <> "" Then objOutpay.Invoices.DistributionRule5 = InDT.Rows(i)("cc5").ToString
                            objOutpay.Invoices.Add()
                        End If
                    Next
...
#End Region
                    ...
                    If ret <> 0 Then
                        'If objaddon.objcompany.InTransaction Then objaddon.objcompany.EndTransaction(SAPbobsCOM.BoWfTransOpt.wf_RollBack)
                        objaddon.objapplication.StatusBar.SetText("Outgoing Payment: " & GetBranchName(Branch) & " BPCode: " & CardCode & "-" & objaddon.objcompany.GetLastErrorDescription & "-" & objaddon.objcompany.GetLastErrorCode & " on Line: " & LineNum, SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                        System.Runtime.InteropServices.Marshal.ReleaseComObject(objOutpay)
                        Return False
                    Else
                        'If objaddon.objcompany.InTransaction Then objaddon.objcompany.EndTransaction(SAPbobsCOM.BoWfTransOpt.wf_Commit)
                        DocEntry = objaddon.objcompany.GetNewObjectKey()
                        EditText13.Value = DocEntry
                        objaddon.objapplication.StatusBar.SetText("Outgoing Payment successfully created..." & GetBranchName(Branch) & " BPCode: " & CardCode, SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Success)
                        System.Runtime.InteropServices.Marshal.ReleaseComObject(objOutpay)
                        GC.Collect()
                        If JournalEntry_BranchTransfer(objFinalDT, CurBranch, CurBPCode) = False Then
                            objaddon.objapplication.StatusBar.SetText("JE_BranchTransfer" & GetBranchName(Branch), SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Warning)
                            Return False
                        End If
                        Return True
                    End If
            ...
            Catch ex As Exception
                objaddon.objapplication.StatusBar.SetText("Outgoing Payment: " & GetBranchName(Branch) & "-" & ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                Return False
            End Try
        End Function
        ...
        Private Function JournalEntry_BranchTransfer(ByVal InDT As DataTable, ByVal Branch As String, ByVal CardCode As String) As Boolean
            Try
                ...
                Dim BranchTotal As Double = 0, ActTotal As Double = 0, ExcRate As Double = 0, CurTotal As Double = 0
                ...
                For i As Integer = 0 To InDT.Rows.Count - 1
                    If InDT.Rows(i)("branchc").ToString = Branch Then
                        ...
                        Else
                            ...
                            'InvTotal = Math.Round(CDbl(InDT.Rows(i)("paytot").ToString), SumRound) * ExcRate
                        End If
                    End If
                Next

                'ActTotal = IIf(CDbl(EditText3.Value) > CDbl(EditText27.Value), (CDbl(EditText3.Value) - CDbl(EditText27.Value)), (CDbl(EditText27.Value) - CDbl(EditText3.Value)))
                'If EditText18.Value <> MainCurr Then
                '    BranchTotal = Math.Round(BranchTotal - CDbl(EditText3.Value), SumRound)
                'Else
                '    BranchTotal = Math.Round(CurTotal - CDbl(EditText3.Value), SumRound)
                'End If

                BranchTotal = Math.Round(BranchTotal - CDbl(EditText3.Value), SumRound)

                'BranchTotal = Math.Round(CDbl(EditText3.Value) - CurTotal, SumRound)
                ...
                objjournalentry.Reference = "Out Payment JE"
                objjournalentry.Memo = "Posted thro' Outpay On:" & Now.ToString
                objjournalentry.UserFields.Fields.Item("U_PayOutNo").Value = EditText2.Value
                If Localization = "IN" Then
                    If objaddon.HANA Then
        ...
        Private Function SameBranchReconciliation_Old(ByVal InDT As DataTable) As Boolean
            Try
                ...
                Dim RecAmount, Amount As Double
                ...
                GetStat = objaddon.objglobalmethods.getSingleValue("SELECT CASE WHEN T0.""DebCred"" = 'C' AND T0.""BalDueCred"" = 0 THEN 'Reconciled' WHEN T0.""DebCred"" = 'C' AND T0.""Credit"" = T0.""BalDueCred"" THEN 'Unreconciled' " &
                                                                   ...
                                                                   " END ""Status"" FROM JDT1 T0 INNER JOIN OJDT T1 ON T0.""TransId"" = T1.""TransId"" WHERE T0.""TransId"" = (Select ""TransId"" from OVPM where ""DocEntry""=" & EditText13.Value & ") " &
                ...
                For DTRow As Integer = 0 To InDT.Rows.Count - 1
                    If InDT.Rows(DTRow)("branchc").ToString = CurBranch Then
                        If Row = 0 Then
                            Dim Outpaytranid As String = objaddon.objglobalmethods.getSingleValue("select ""TransId"" from OVPM where ""DocEntry"" =" & EditText13.Value & "")
                            objRs.DoQuery("select CASE WHEN T1.""BalDueCred""<>0  THEN  T1.""BalDueCred"" ELSE T1.""BalDueDeb"" END AS ""Balance"",T1.""Line_ID"" from JDT1 T1 where T1.""ShortName"" ='" & CurBPCode & "' and T1.""TransId""=(Select ""TransId"" from OVPM where ""DocEntry""=" & EditText13.Value & ") ")
                            Amount = CDbl(objRs.Fields.Item(0).Value.ToString) 'CDbl(Amount) ' IIf(CDbl(Amount) < 0, -CDbl(Amount), CDbl(Amount)) '-CDbl(Amount) 
                            If objRs.RecordCount > 0 Then
                                ...
                                openTrans.InternalReconciliationOpenTransRows.Item(Row).TransId = Outpaytranid 'InDT.Rows(Row)("transid").ToString
                                ...
                                openTrans.InternalReconciliationOpenTransRows.Item(Row).ReconcileAmount = Amount ' CDbl(objRs.Fields.Item(0).Value.ToString)
                                Row += 1
                            End If
                            If EditText22.Value <> "" Then
                            ...
                            If EditText14.Value <> "" Then
                                objRs.DoQuery("select CASE WHEN T1.""BalDueCred""<>0  THEN  T1.""BalDueCred"" ELSE T1.""BalDueDeb"" END AS ""Balance"",T1.""Line_ID"" from OJDT T0 join JDT1 T1 ON T0.""TransId""=T1.""TransId"" where T1.""BPLId""='" & CurBranch & "' and T1.""TransId""='" & EditText14.Value & "' and T1.""ShortName""='" & CurBPCode & "'")
                                ...
                                If objRs.RecordCount > 0 Then
                                    If Val(objRs.Fields.Item(0).Value.ToString) <> 0 Then
                                        Amount = CDbl(objRs.Fields.Item(0).Value.ToString)
        ...
        Private Function SameBranchReconciliation(ByVal InDT As DataTable) As Boolean
            Try
                ...
                For DTRow As Integer = 0 To InDT.Rows.Count - 1
                    If InDT.Rows(DTRow)("branchc").ToString = CurBranch Then
                        If Row = 0 Then
                            Dim Inpaytranid As String = objaddon.objglobalmethods.getSingleValue("select ""TransId"" from OVPM where ""DocEntry"" =" & EditText13.Value & "")
                            'Dim Amount As String = objaddon.objglobalmethods.getSingleValue("select ""NoDocSum"" from ORCT where ""DocEntry"" =" & EditText13.Value & "")
                            objRs.DoQuery("select CASE WHEN T1.""BalDueCred""<>0  THEN  T1.""BalDueCred"" ELSE T1.""BalDueDeb"" END AS ""Balance"",T1.""Line_ID"",T1.""DebCred"" from JDT1 T1 where T1.""ShortName"" ='" & CurBPCode & "' and T1.""TransId""=(Select ""TransId"" from OVPM where ""DocEntry""=" & EditText13.Value & ") ")
                            ...
                            If objRs.RecordCount > 0 And CDbl(objRs.Fields.Item(0).Value.ToString) <> 0 Then
                                'If objRs.Fields.Item(2).Value.ToString = "C" Then RecAmount = CDbl(objRs.Fields.Item(0).Value.ToString) Else RecAmount = CDbl(objRs.Fields.Item(0).Value.ToString)
                                'Dim cred As String = objRs.Fields.Item(2).Value.ToString
                ...
                Try
                    reconParams = service.Add(openTrans)
                Catch ex As Exception
                    objaddon.objapplication.StatusBar.SetText("SameBranch_Reco: " + ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                    Return False
                End Try
                Dim Reconum As Integer = reconParams.ReconNum
        ...
        'Private Function JEInternReco_old(ByVal InDT As DataTable, ByVal Row As Integer, ByVal cardcode As String, ByVal transid As String, Optional ByVal Disc As String = "") As Boolean
        '    Try
        '        Dim service As IInternalReconciliationsService = objaddon.objcompany.GetCompanyService().GetBusinessService(ServiceTypes.InternalReconciliationsService)
        '        Dim openTrans As InternalReconciliationOpenTrans = service.GetDataInterface(InternalReconciliationsServiceDataInterfaces.irsInternalReconciliationOpenTrans)
        '        Dim reconParams As IInternalReconciliationParams = service.GetDataInterface(InternalReconciliationsServiceDataInterfaces.irsInternalReconciliationParams)
        '        openTrans.CardOrAccount = CardOrAccountEnum.coaCard
        '        objRs = objaddon.objcompany.GetBusinessObject(SAPbobsCOM.BoObjectTypes.BoRecordset)
        '        Dim RecAmount, Amount As Double '= IIf(CDbl(InDT.Rows(Row)("paytot").ToString) < 0, -CDbl(InDT.Rows(Row)("paytot").ToString), CDbl(InDT.Rows(Row)("paytot").ToString))
        '        'RecAmount = IIf(Amount < 0, -Amount, Amount)

        '        If InDT.Rows(Row)("debcred").ToString = "C" Then RecAmount = CDbl(InDT.Rows(Row)("paytot").ToString) Else RecAmount = -CDbl(InDT.Rows(Row)("paytot").ToString)
        ...
        Private Function JEInternReco(ByVal InDT As DataTable, ByVal Row As Integer, ByVal cardcode As String, ByVal transid As String, Optional ByVal Disc As String = "") As Boolean
            Try
                ...
                Else
                    ExRate = GetTransaction_ExchangeRate(InDT.Rows(Row)("object").ToString, InDT.Rows(Row)("transid").ToString)
                ...
                If objRs.RecordCount > 0 Then
                    'If objRs.Fields.Item(0).Value.ToString = "C" Then Amount = CDbl(objRs.Fields.Item(2).Value.ToString) Else Amount = CDbl(objRs.Fields.Item(2).Value.ToString)
                    Amount = Math.Round(CDbl(objRs.Fields.Item(2).Value.ToString), SumRound)
                End If
                Dim DocDate As Date = Date.ParseExact(EditText0.Value, "yyyyMMdd", System.Globalization.DateTimeFormatInfo.InvariantInfo)
                openTrans.ReconDate = DocDate
                openTrans.InternalReconciliationOpenTransRows.Add()
                ...
                Try
                    reconParams = service.Add(openTrans)
                Catch ex As Exception
                    objaddon.objapplication.StatusBar.SetText("Disc Recon..." & ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error) : Return False
                End Try
            ...
            Try
                ...
                Try
                    If EditText25.Value = "" Or EditText22.Value = "" Then
                        ...
                        If RecFlag Then
                            If Amount < 0 Then objjournalentry.Lines.AccountCode = Forexloss Else objjournalentry.Lines.AccountCode = Forexgain
                        Else
                ...
                Try
                    ...
                    If TransId = "" Then
                        Try
                            ...
                            objjournalentry.Lines.AccountCode = GLCode
                            If forex <> 0 Then
                                If BranchTotal < 0 Then objjournalentry.Lines.Debit = -CurTot Else objjournalentry.Lines.Credit = CurTot
                            ...
                            If forex <> 0 Then
                                ...
                                If forex < 0 Then objjournalentry.Lines.AccountCode = Forexloss Else objjournalentry.Lines.AccountCode = Forexgain
                                If forex < 0 Then objjournalentry.Lines.Debit = forexAmt Else objjournalentry.Lines.Credit = forexAmt
                                objjournalentry.Lines.BPLID = Branch
                                objjournalentry.Lines.Add()
                            End If
                            ...
                            Else
                                ...
                                If Matrix0.Columns.Item("jeno").Cells.Item(CInt(MatLine)).Specific.String <> "" And Matrix0.Columns.Item("recono").Cells.Item(CInt(MatLine)).Specific.String = "" Then
                                    If Branchwise_InternalReconciliation(InDT, MatLine, TransId, Branch) = False Then
                                        objaddon.objapplication.StatusBar.SetText("Branchwise_InternalReco" & GetBranchName(Branch), SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error)
                                        Return False
                                    End If
                                End If
                                objform.Update()
        ...
        Private Function Branchwise_InternalReconciliation(ByVal InDT As DataTable, ByVal Line As Integer, ByVal transid As String, ByVal Branch As String) As Boolean
            Try
                ...
                Try
                    reconParams = service.Add(openTrans)
                Catch ex As Exception
                    objaddon.objapplication.StatusBar.SetText("Branchwise Reconciled Error : " & GetBranchName(Branch) & "-" & ex.Message, SAPbouiCOM.BoMessageTime.bmt_Short, SAPbouiCOM.BoStatusBarMessageType.smt_Error) : Return False
                End Try
